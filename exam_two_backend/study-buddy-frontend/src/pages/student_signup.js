...
function StudentSignUp(){
    ...
    function handleSubmit() {//event was removed from parentheses
        axios.get(`http://${process.env.NEXT_PUBLIC_STUDY_BUDDY_API_URL}/createuser`, { params: { user: username, email: email, pass: password, type: "student"}})
            .then((response) => {
    ...
    return (
        <div className="containerStyle">
            <h1 className="h1Style">New Student</h1>
