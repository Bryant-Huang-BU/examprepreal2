...
function StudentSignUp(){
    ...
    const handleSubmit = () => {//event was removed from parentheses
        ...
        fetch (`http://localhost:8080/movie/update/${id}`, {method: 'POST' , headers: {'Content-Type': 'application/x-www-form-urlencoded'}}, {params: {title: title, genre: genres, year: movieYear, score: rottenTomatoesScore, studio: leadStudio}, mode: 'no-cors',})
            .then((response ) => {
